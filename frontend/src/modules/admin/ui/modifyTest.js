...
const RenderAnswers = ({ answerType, activeQuestion, handleAnswerChange, updatedTest, contentType, localImages }) => {
...
const ModifyTest = () => {
    ...
    const handleModify = async () => {
        try {
            ...
            console.log("updated seccessufully");
            handleRefresh();
        } catch (error) {
                                        ...
                                        <Box sx={{ display: 'flex', alignItems: 'center', mb: 2, pt: 2 }}>
                                            <Grid container spacing={2} sx={{ width: '100%' }}>
                                                ...
                                                <Grid item xs={6} sx={{ pt: '0 !important' }}>
                                                    <Box sx={{ position: 'relative', display: 'flex', alignItems: 'center', justifyContent: updatedTest.questions[activeQuestion].image ? 'end' : 'start' }}>
                                                        <input
                                                            type="file"
                                                            accept="image/*"
                                                            id="file-upload"
